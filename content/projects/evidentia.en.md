---
author: CEDIS
title: "Evidentia Review Project"
...
summary: Ongoing CEDIS project focused on the continuous research, evolution, and validation of methods, workflows, and capabilities for systematic reviews, with Evidentia Review as its resulting product.
...
The main current outcome of that effort is the digital product {{< link-interno "/products/evidentia" "Evidentia Review" >}}, already publicly available. In other words, this page describes the **ongoing research and development project**, while the product page describes the **platform that has already been delivered for use**.
...
- {{< link-interno "/products/evidentia/" "Evidentia Review product" >}}