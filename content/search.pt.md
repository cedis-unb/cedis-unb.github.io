...
<div class="rounded-3xl border border-black/5 bg-white/85 p-4 shadow-[0_18px_50px_rgba(15,23,42,0.06)] backdrop-blur dark:border-white/10 dark:bg-white/4 md:p-6">
    ...
    <p class="mt-6 text-sm leading-6 text-gray-500 dark:text-white/60">
        Dica: use aspas para uma expressão exata (ex.: <code class="rounded bg-stone-100 px-1.5 py-0.5 text-xs dark:bg-white/6">"engenharia de software"</code>) ou combine termos para restringir o resultado.
    </p>
</div>
