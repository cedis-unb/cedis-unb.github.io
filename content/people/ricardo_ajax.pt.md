...
<div id="previous-collaborators" x-data="{ showPrevious: false }">
    ...
    {{< publications caput="#### Doutorado" year="" types="phd" advisors="ricardo_ajax" notypes="" tags="" notags="" >}}
    {{< publications caput="#### Mestrado" year="" types="dissertation" advisors="ricardo_ajax" notypes="" tags="" notags="" >}}
    {{< publications caput="#### Especialização" year="" types="specialization" advisors="ricardo_ajax" notypes="" tags="" notags="" >}}
    {{< filterPeople caput="#### Iniciação Científica" categories="scientific_initiation" advisors="ricardo_ajax" tags="inactive" notags="">}}
    {{< publications caput="#### Trabalho de Conclusão de Curso (TCC)" year="" types="tcc" advisors="ricardo_ajax" notypes="" tags="" notags="" >}}
    </div>
  </div>
