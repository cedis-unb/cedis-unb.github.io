...
### Orientações atuais
{{< filterPeople caput="#### Doutorado" categories="phd_candidate" advisors="ricardo_ajax" tags="" notags="inactive">}}
{{< filterPeople caput="#### Mestrado" categories="master_student" advisors="ricardo_ajax" tags="" notags="inactive">}}
{{< filterPeople caput="#### Especialização Pós-Graduação" categories="specialization" advisors="ricardo_ajax" tags="" notags="inactive">}}
{{< filterPeople caput="#### Iniciação Científica" categories="scientific_initiation" advisors="ricardo_ajax" tags="" notags="inactive">}}
{{< filterPeople caput="#### Trabalho de Conclusão de Curso (TCC)" categories="tcc" advisors="ricardo_ajax" tags="" notags="inactive">}}
...
{{< filterPeople caput="#### Doutorado" categories="phd_candidate" advisors="ricardo_ajax" tags="inactive" notags="">}}
{{< filterPeople caput="#### Mestrado" categories="master_student" advisors="ricardo_ajax" tags="inactive" notags="">}}
{{< filterPeople caput="#### Especialização Pós-Graduação" categories="specialization" advisors="ricardo_ajax" tags="inactive" notags="">}}
{{< filterPeople caput="#### Iniciação Científica" categories="scientific_initiation" advisors="ricardo_ajax" tags="inactive" notags="">}}
{{< filterPeople caput="#### Trabalho de Conclusão de Curso (TCC)" categories="tcc" advisors="ricardo_ajax" tags="inactive" notags="">}}
    </div>
  </div>
