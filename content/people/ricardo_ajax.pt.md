...
- Graduação em Engenharia Elétrica - Universidade de Brasília (UnB), Brasil (1977-1981).
- Formação complementar em medição e análise, análise de pontos de função, CMMI, MPS.Br, SCAMPI, gestão de projetos e melhoria de processos.

## {{< i18n "people_professional_activities" >}}
- Professor na UnB/FGA desde 2011, ministrando disciplinas como Melhoria de Processo de Software, Técnicas de Medição Funcional e Estimativas de Software, Verificação e Validação de Software, Medição e Análise e Projeto Integrador entre Engenharias.
...
{{< filterPeople caput="#### " caputKey="phd_candidate" categories="phd_candidate" advisors="ricardo_ajax" tags="" notags="inactive" sort="alpha" grid="true">}}
{{< filterPeople caput="#### " caputKey="master_student" categories="master_student" advisors="ricardo_ajax" tags="" notags="inactive" sort="alpha" grid="true">}}
{{< filterPeople caput="#### " caputKey="specialization" categories="specialization" advisors="ricardo_ajax" tags="" notags="inactive" sort="alpha" grid="true">}}
{{< filterPeople caput="#### " caputKey="scientific_initiation" categories="scientific_initiation" advisors="ricardo_ajax" tags="" notags="inactive" sort="alpha" grid="true">}}
{{< filterPeople caput="#### " caputKey="tcc" categories="tcc" advisors="ricardo_ajax" tags="" notags="inactive" sort="alpha" grid="true">}}
<div id="previous-collaborators" x-data="{ showPrevious: false }">
    ...
    {{< publications caput="#### " caputKey="phd_candidate"  year="" types="phd" advisors="ricardo_ajax" notypes="" tags="" notags="active" sort="year_alpha" grid="true">}}
    {{< publications caput="#### " caputKey="master_student" year="" types="dissertation" advisors="ricardo_ajax" notypes="" tags="" notags="active" sort="year_alpha" grid="true">}}
    {{< publications caput="#### " caputKey="specialization" year="" types="specialization" advisors="ricardo_ajax" notypes="" tags="" notags="active" sort="year_alpha" grid="true">}}
    {{< filterPeople caput="#### " caputKey="scientific_initiation" categories="scientific_initiation" advisors="ricardo_ajax" tags="" notags="active" sort="year_alpha" grid="true">}}
    {{< publications caput="#### " caputKey="tcc" year="" types="tcc" advisors="ricardo_ajax" notypes="" tags="" notags="active" sort="year_alpha" grid="true">}}
...
## {{< i18n "people_contact" >}}
- {{< i18n "people_contact_professional" >}}: Universidade de Brasília, Campus Gama, Área Especial de Indústria Projeção A, Prédio UED, Sala 21, Setor Leste (Gama), Brasília - DF, Brasil.
