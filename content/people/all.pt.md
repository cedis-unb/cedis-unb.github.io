...
<span class="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-3 py-1 text-sm font-semibold text-gray-700 dark:border-white/10 dark:bg-white/3 dark:text-white/78"><strong>{{< peopleCount status="active" >}}</strong> rede ativa</span>
