...
<div id="previous-collaborators" x-data="{ showPrevious: false }">
    ...
    {{< publications caput="#### " caputKey="specialization" year="" types="specialization" advisors="daniel_sundfeld" notypes="" tags="active_learning,education" notags="active" sort="supervision" >}}
