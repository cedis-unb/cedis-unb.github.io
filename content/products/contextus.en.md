...
On **February 18, 2026**, the software received a **computer program registration certificate** granted by **INPI**, under process **BR512026000889-1**, with **IBICT** as the rights holder. The certificate formalizes the system's legal protection and reinforces the institutional recognition of the technological output associated with the project. More details are available in the {{< link-interno "/posts/news-post.023" "news item about the registration" >}} and in the [official certificate](/files/certificado_Contextus.pdf).
