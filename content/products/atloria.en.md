...
The source code of the project is available on [GitHub](https://github.com/CedisUnB/Atloria). A compiled Android build (APK) can be downloaded from [GitHub Releases](https://github.com/CedisUnB/Atloria/releases). The software is also archived on [Zenodo](https://zenodo.org/records/20832755).
