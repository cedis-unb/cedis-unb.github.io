---
author: CEDIS
title: "Galactic Journey Gamification"
...
The **Galactic Journey** gamification, developed as part of the **{{< link-interno "/projects/canal_ciencia" "Canal Ciência Project" >}}**, is a collaboration between the **Center for Studies, Development, and Innovation in Software (CEDIS)** and the **Brazilian Institute of Information in Science and Technology (IBICT)**, funded by **Finatec**. The project is coordinated at CEDIS by **Professors {{< link-interno "/people/sergio_freitas" "Sergio Freitas" >}}** and **{{< link-interno "/people/cristiane_ramos" "Cristiane Ramos" >}}**, with **Leda Sampson** leading the coordination at IBICT.
...
The development team included **Mylena Angélica Silva Farias**, a PIBIC advisee of Prof. Sergio Freitas, and **Marcus Vinicius Martins** and **Wildemberg Sales**, PIBIC advisees of Prof. Cristiane Ramos. The project has gained academic recognition through international publications on motivational profiling, gamification design, and the Galactic Journey experience at Canal Ciência, including a **Best Paper** award.
