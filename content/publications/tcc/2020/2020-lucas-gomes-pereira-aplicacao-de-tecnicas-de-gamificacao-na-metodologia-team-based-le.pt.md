---
title: 'Aplicação de Técnicas de Gamificação na Metodologia Team-Based Learning: Aplicando
  o Octalysis na Fase 1 do TBL'
...
github_repo: ''
zenodo_record: ''
summary: Tcc de Lucas Gomes Pereira (2020).
bibtex: "@mastersthesis{2020-lucas-gomes-pereira-aplicacao-de-tecnicas-de-gamificacao-na-metodologia-team-based-le,\n\
  \  author = {Lucas Gomes Pereira},\n  title = {Aplicação de Técnicas de Gamificação\
  \ na Metodologia Team-Based Learning: Aplicando o Octalysis na Fase 1 do TBL},\n\
  \  year = {2020},\n  publisher = {Biblioteca Central da Universidade de Brasília}\n\
  }"
aliases:
