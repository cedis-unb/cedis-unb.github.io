---
title: 'OpenBatch: serviço de processamento em lote para nuvem privada'
...
github_repo: ''
zenodo_record: ''
summary: Tcc de Marcus Vinicius P. Martins (2025).
bibtex: "@mastersthesis{2025-marcus-vinicius-p-martins-openbatch-servico-de-processamento-em-lote-para-nuvem-priva,\n\
  \  author = {Marcus Vinicius P. Martins},\n  title = {OpenBatch: serviço de processamento\
  \ em lote para nuvem privada},\n  year = {2025},\n  publisher = {Biblioteca Central\
  \ da Universidade de Brasília}\n}"
aliases:
- /publications/2025-marcus-vinicius-p-martins-openbatch-servico-de-processamento-em-lote-para-nuvem-priva/
---
