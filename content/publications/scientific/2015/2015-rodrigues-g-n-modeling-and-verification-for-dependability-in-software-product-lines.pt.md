...
github_repo: ''
zenodo_record: ''
summary: Conference de RODRIGUES, G. N., ALVES, V. R., NUNES, V., LANNA, André Luiz
  Peron Martins, CORDY, M., SCHOBBENS, P., SHARIFLOO, A. M., LEGAY, A. (2015).
bibtex: "@inproceedings{2015-rodrigues-g-n-modeling-and-verification-for-dependability-in-software-product-lines,\n\
  \  author = {RODRIGUES, G. N. and ALVES, V. R. and NUNES, V. and LANNA, André Luiz\
  \ Peron Martins and CORDY, M. and SCHOBBENS, P. and SHARIFLOO, A. M. and LEGAY,\
  \ A.},\n  title = {Modeling and Verification for Dependability in Software Product\
  \ Lines},\n  year = {2015},\n  booktitle = {International Symposium on High Assurance\
  \ Systems Engineering (HASE)},\n  address = {Daytona Beach},\n  doi = {10.1109/HASE.2015.34}\n\
  }"
aliases:
- /publications/2015-rodrigues-g-n-modeling-and-verification-for-dependability-in-software-product-lines/
---
