---
title: "Which framework to use when gamifying a class? A systematic review draws the map"
...
The thesis’s contribution is not to propose a new framework: it is to help newcomers choose among those that already exist. By consolidating criteria and application cases, the author gives educators a compass for what is usually decided by blog-post echo. It is typical {{< link-interno "/areas/gamification/" "gamification" >}} research work: putting order in an expanding field without suffocating its methodological diversity.

The full text — written in Portuguese — is available at the [UnB Undergraduate Theses Digital Library](https://www.bdm.unb.br/handle/10483/30628).
