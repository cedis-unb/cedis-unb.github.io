---
title: "AgroMart evolves: an undergraduate thesis opens the source, adds payments, and manages co-farmers"
...
By taking on these three fronts, the thesis continues a project that has already crossed several student generations and connects {{< link-interno "/areas/green_software/" "Green Software" >}} with {{< link-interno "/areas/transformation/" "digital transformation" >}} guided by social impact.

The full text — written in Portuguese — is available at the [UnB Undergraduate Theses Digital Library](https://www.bdm.unb.br/handle/10483/33850).
