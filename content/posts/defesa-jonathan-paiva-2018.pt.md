---
title: "Motoristas como sensores: TCC propõe app colaborativo para monitorar frota urbana"
...
O trabalho toca {{< link-interno "/areas/software_architecture/" "arquitetura de software" >}} e {{< link-interno "/areas/transformation/" "transformação digital urbana" >}}, apostando em soluções de baixa fricção que dependem mais de engajamento social do que de infraestrutura pesada.

O TCC pode ser lido na [Biblioteca Digital da Produção Intelectual Discente da UnB](https://www.bdm.unb.br/handle/10483/21590).
