---
title: "Reading what's already logged: an undergraduate thesis proposes planning process improvements from issues"
...
The work speaks to {{< link-interno "/areas/software_quality/" "software quality" >}} and {{< link-interno "/areas/software_requirements/" "requirements engineering" >}} — showing that existing data can answer questions most teams still address by intuition.

The full text — written in Portuguese — is available at the [UnB Undergraduate Theses Digital Library](https://www.bdm.unb.br/handle/10483/30204).
