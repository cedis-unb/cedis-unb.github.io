---
title: "Interfaces que induzem ao erro: TCC cataloga armadilhas comuns — e como evitá-las"
...
A pesquisa cataloga problemas frequentes de interface que empurram usuários para o erro, discute como identificá-los durante o desenvolvimento e propõe recomendações práticas para mitigá-los. É um trabalho de {{< link-interno "/areas/software_quality/" "qualidade de software" >}} pensado como serviço: transformar um saber que costuma circular por experiência em uma referência que possa ser consultada durante decisões de projeto.

O TCC pode ser lido na [Biblioteca Digital da Produção Intelectual Discente da UnB](https://www.bdm.unb.br/handle/10483/30367).
