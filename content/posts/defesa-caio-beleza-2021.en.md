---
title: "Interfaces that induce error: an undergraduate thesis catalogues common traps — and how to avoid them"
...
The research catalogues frequent interface problems that push users toward error, discusses how to identify them during development, and proposes practical recommendations to mitigate them. It is a piece of {{< link-interno "/areas/software_quality/" "software quality" >}} work conceived as a service: turning what usually circulates as tacit experience into a reference that can be consulted during design decisions.

The full text — written in Portuguese — is available at the [UnB Undergraduate Theses Digital Library](https://www.bdm.unb.br/handle/10483/30367).
