---
title: "Time voluntário, testes assíncronos: TCC monta estratégia de QA em pandemia"
...
A resposta articula {{< link-interno "/areas/verival/" "verificação e validação" >}} com {{< link-interno "/areas/soft_skills/" "trabalho em equipe distribuído" >}}. O trabalho propõe uma estratégia de testes com definição clara de responsabilidades, cadência compatível com voluntariado e pontos de checagem que reduzem o custo cognitivo de acompanhar o que já foi feito. É uma contribuição que serve para muito além do Doarti — em uma década em que times remotos se tornaram regra e não exceção.

O TCC pode ser lido na [Biblioteca Digital da Produção Intelectual Discente da UnB](https://www.bdm.unb.br/handle/10483/30626).
