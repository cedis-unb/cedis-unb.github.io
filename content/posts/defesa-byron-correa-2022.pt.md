---
title: "AgroMart em evolução: TCC abre o código, adiciona pagamentos e gestão de co-agricultores"
...
Ao encaminhar essas três frentes, o TCC dá continuidade a um projeto que já cruzou várias gerações de alunos e conecta {{< link-interno "/areas/green_software/" "Green Software" >}} com {{< link-interno "/areas/transformation/" "transformação digital" >}} orientada por impacto social.

O TCC está disponível na [Biblioteca Digital da Produção Intelectual Discente da UnB](https://www.bdm.unb.br/handle/10483/33850).
