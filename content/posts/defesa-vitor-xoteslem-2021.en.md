---
title: "Volunteer team, asynchronous testing: an undergraduate thesis builds a QA strategy in pandemic times"
...
The answer weaves {{< link-interno "/areas/verival/" "verification and validation" >}} with {{< link-interno "/areas/soft_skills/" "distributed teamwork" >}}. The work proposes a testing strategy with clear responsibility assignment, a cadence compatible with volunteering, and checkpoints that reduce the cognitive cost of following what has already been done. It is a contribution that reaches well beyond Doarti — in a decade in which remote teams became the norm rather than the exception.

The full text — written in Portuguese — is available at the [UnB Undergraduate Theses Digital Library](https://www.bdm.unb.br/handle/10483/30626).
