---
title: "Milissegundos importam: TCC mede o impacto de escolhas de código no Android"
...
O trabalho enfrenta o problema por dentro: escolhe técnicas comuns de programação em Android e mede empiricamente o impacto de cada uma sobre o desempenho de aplicações. Resultado: um material que pode ser usado como referência prática por quem precisa decidir entre variações de código sem entrar em debates sem fim. É uma contribuição típica de {{< link-interno "/areas/software_quality/" "qualidade de software" >}} — evidência quantitativa para embasar decisões que, na prática, moldam a experiência de quem usa.

O TCC pode ser lido na [Biblioteca Digital da Produção Intelectual Discente da UnB](https://www.bdm.unb.br/handle/10483/11323).
