---
title: "Barramento de Serviços da UnB ganha monitoramento: dissertação instrumenta a espinha dorsal digital da universidade"
...
Universidades públicas rodam sobre camadas de sistemas legados, novos e híbridos que precisam conversar entre si. Na UnB, esse diálogo passa pelo Barramento de Serviços — um ESB que conecta os principais sistemas acadêmicos e administrativos. **A dissertação defendida em fevereiro de 2020 por Felipe Evangelista dos Santos no PPCA/UnB coloca essa infraestrutura sob observação metódica** — sob orientação do Prof. Dr. {{< link-interno "/people/sergio_freitas" "Sergio Antônio Andrade de Freitas" >}}.

O trabalho não critica o ESB como escolha arquitetural; toma-o como fato e resolve um problema clássico da operação SOA: sem monitoramento adequado, o ESB vira caixa preta cuja falha só se descobre quando o serviço final quebra. O autor implementa a integração do Barramento com ferramentas de monitoramento capazes de expor latência, taxa de erro e traçabilidade de mensagens em produção. É um investimento que muda o custo de operar: incidentes deixam de ser detectados por reclamação e passam a ser detectados por alerta.
