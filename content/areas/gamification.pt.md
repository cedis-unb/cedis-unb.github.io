...
Especialista em gamificação e professor Titular da Universidade de Brasília - UnB. Sua experiência abrange tanto a gamificação na Educação quanto a aplicação desta metodologia em outros campos. Ele é reconhecido por integrar elementos de design de jogos em contextos educacionais e empresariais, visando aumentar a motivação, participação e engajamento dos usuários. Sua dedicação à pesquisa em Gamificação e [Learning Analytics](/areas/learning_analytics) tem contribuído para a inovação e o desenvolvimento de novas estratégias de ensino e aprendizagem na área de Engenharia de Software. {{< link-interno "/people/sergio_freitas" "Mais informações sobre o coordenador" >}}.
...
1. Projeto de pesquisa "[Gamificação do Portal Canal Ciência](/projects/canal_ciencia)": o projeto visa enriquecer a experiência dos usuários do portal, utilizando técnicas avançadas de gamificação baseadas na ferramenta Octalisys. Início: 2023, status: em andamento.
