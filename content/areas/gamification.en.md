...
Gamification is a process that uses elements, techniques, and game design mechanics in contexts not related to games, aiming to increase user motivation, participation, and engagement. Gamification has been applied in various fields, such as education, marketing, health, and corporate training, becoming a growing trend over the last decade. Recently, the group launched the website [Gamification.org](https://gamificacao.org/en), which gathers resources, projects, and discussions related to the subject. The initiative seeks to consolidate knowledge and provide a collaborative environment for researchers, educators, and professionals interested in gamification.
